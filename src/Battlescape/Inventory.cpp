 ...
 */
Inventory::Inventory(Game *game, int width, int height, int x, int y, bool base) : InteractiveSurface(width, height, x, y), _game(game), _selUnit(0), _selItem(0), _tu(true), _base(base), _groundOffset(0), _animFrame(0), _xBeforeDrag(0), _yBeforeDrag(0), _dragging(false), _clicked(false), _mouseOverItem(0)
{
